...
public class RssItem implements Comparable<RssItem>, Parcelable {
  ...
  public RssItem(Parcel source) {
    ...
    mediaContent = data.getString("imageiphone");
    pubDate = (Date) data.getSerializable("pubDate");
    description = data.getString("description");
    content = data.getString("media:content");
  ...
  public void writeToParcel(Parcel dest, int flags) {
    ...
    data.putString("media:content", content);
    data.putString("imageiphone", mediaContent);
